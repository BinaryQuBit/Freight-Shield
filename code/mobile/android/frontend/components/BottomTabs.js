...
import { Animated, TouchableOpacity, View, StyleSheet, Easing, Text } from 'react-native';
import { createBottomTabNavigator } from '@react-navigation/bottom-tabs';
import HomeScreen from '../screens/HomeScreen';
import LogBookScreen from '../screens/LogBookScreen2';
import SettingsScreen from '../screens/SettingsScreen';
import { FontAwesomeIcon } from '@fortawesome/react-native-fontawesome';
import { faHome, faBook, faCog, faTelevision } from '@fortawesome/free-solid-svg-icons';
    ...
    <Tab.Navigator
      ...
      screenOptions={({ route }) => ({
        tabBarIcon: ({ color, size, focused }) => {
          ...
          return <FontAwesomeIcon icon={icon}  size={focused ? size * 1.1 : size} color={iconColor} />;
        },
        tabBarStyle: styles.tabBar,
        headerShown: false,
        tabBarLabel: ({ focused }) => {
            // Return null to make label disappear when focused

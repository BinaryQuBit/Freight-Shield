...
export default function ShipperCompanyDetailsForm() {
  ...
  // const [apptNumberError, setApptNumberError] = useState("");
  // const [cityError, setCityError] = useState("");
  // const [provinceError, setProvinceError] = useState("");
  // const [postalCodeError, setPostalCodeError] = useState("");
  // const [countryError, setCountryError] = useState("");
  // const [mailingStreetAddressError, setMailingStreetAddressError] = useState("");
  // const [mailingApptNumberError, setMailingApptNumberError] = useState("");
  ...
  //   // Reset Error Hooks // I am leaving it here. Dont fuck it!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  return (
    <Box>This is to push to the server</Box>
    // <Box mb={20}>
    //   <Card
    //     p="20px"
    //     m={"20px"}

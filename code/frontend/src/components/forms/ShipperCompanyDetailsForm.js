    ...
    <Box mb={20}>
      <Card p="20px" maxWidth={{ base: "auto", md: "400px" }} mx="auto">
        ...
        <Flex alignItems="center" mt="3">
          ...
          <RadioGroup onChange={setSameAsMailing} value={sameAsMailing} colorScheme="green">
            <Flex>
        ...
        {sameAsMailing === "no" && (
          <>
            <FormControl mt={"3"} id="mailingStreetAddress" isRequired>
              <Input
                type="text"
            ...
            <FormControl mt={"3"} id="mailingApptNumber">
              <Input
                type="text"
                name="mailingApptNumber"
                placeholder="Mailing Apartment, suite, etc."
              />
            </FormControl>
            <Flex>
              <FormControl mt={"3"} mr={"1.5"} id="mailingCity">
                <Input
                  type="text"
                  name="mailingCity"
              ...
              <FormControl mt={"3"} ml={"1.5"} id="mailingProvince">
                <Input
                  type="text"
            ...
            <Flex>
              <FormControl mt={"3"} mr={"1.5"} id="mailingPostalCode">
                <Input
                  type="text"
              ...
              <FormControl mt={"3"} ml={"1.5"} id="mailingCountry">
                <Input
                  type="text"
                  name="mailingCountry"

...
describe("MoreDetails", () => {
  ...
  test("renders modal with shipper details", () => {
    render(<MoreDetails isOpen={true} onClose={() => {}} shipper={shipper} />);
    ...
    expect(screen.getByText(/1111 wascana street/i)).toBeInTheDocument();
    ...
    expect(screen.getByText(/http:\/\/www.example.com/i)).toBeInTheDocument();
